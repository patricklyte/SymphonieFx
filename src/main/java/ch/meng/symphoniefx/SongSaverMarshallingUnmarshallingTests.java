...
public class SongSaverMarshallingUnmarshallingTests {
    ...
    void marshallSongEventTest() {
        ...
        SongEvent unmarshalled = JAXB.unmarshal(reader, SongEvent.class);
        Assertions.assertEquals(songEvent.toString(), unmarshalled.toString());
        Assertions.assertTrue(songEvent.equals(unmarshalled));
    }
}
